...
WebUI.setText(findTestObject('Object Repository/Admin/Keuangan/Search kolom'), 'INV/20200125/PPJI265')

WebUI.click(findTestObject('Object Repository/Admin/Keuangan/Button Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Keuangan/Validasi/response invoice'), 'INV/20200125/PPJI265')
