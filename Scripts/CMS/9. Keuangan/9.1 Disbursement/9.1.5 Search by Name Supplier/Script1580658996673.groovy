...
WebUI.setText(findTestObject('Object Repository/Admin/Keuangan/Search kolom'), 'jakarata rekening')

WebUI.click(findTestObject('Object Repository/Admin/Keuangan/Button Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Keuangan/Validasi/response name supplier'), 'jakarata rekening')
