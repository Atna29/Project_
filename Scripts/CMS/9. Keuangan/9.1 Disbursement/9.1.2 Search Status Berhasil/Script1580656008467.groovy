...
WebUI.selectOptionByValue(findTestObject('Object Repository/Admin/Keuangan/Status disbursement'), 'disbursed', false)

WebUI.click(findTestObject('Object Repository/Admin/Keuangan/Button Search'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Keuangan/Validasi/Status BERHASIL'), 'BERHASIL')
