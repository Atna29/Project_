...
WebUI.setText(findTestObject('Admin/Page_Admin_Kategori/input_ TambahKategori_carikat'), 'Beras')
...
WebUI.setText(findTestObject('Admin/Page_Admin_Kategori/input_ TambahKategori_carikat'), '')
