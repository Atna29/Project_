...
WebUI.click(findTestObject('Admin/Page_Admin_Kategori/button_ Tambah Kategori'))

WebUI.click(findTestObject('Admin/Page_Admin_Kategori/button_TAMBAH'))

WebUI.verifyElementText(findTestObject('Admin/Page_Admin_Kategori/span_Nama Kategori tidak boleh kosong'), 'Nama Kategori tidak boleh kosong')
