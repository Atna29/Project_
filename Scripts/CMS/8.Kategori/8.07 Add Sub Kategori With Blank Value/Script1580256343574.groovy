...
WebUI.click(findTestObject('Admin/Page_Admin_Kategori/button_ Tambah Sub Kategori'))

WebUI.setText(findTestObject('Admin/Page_Admin_Kategori/input_Nama Sub Kategori_sub_category_name'), '')

WebUI.click(findTestObject('Admin/Page_Admin_Kategori/button_TAMBAH'))

WebUI.verifyElementText(findTestObject('Admin/Page_Admin_Kategori/span_Nama Sub Kategori tidak boleh kosong'), 'Nama Sub Kategori tidak boleh kosong')

WebUI.delay(3)

WebUI.click(findTestObject('Admin/Page_Admin_Kategori/button_BATAL'))
