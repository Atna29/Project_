...
WebUI.setText(findTestObject('Object Repository/Admin/Pengguna/Atur Pesanan/Search kolom'), 'QA Buyer')

WebUI.click(findTestObject('Object Repository/Admin/Pengguna/Atur Pesanan/Button CARI'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Pengguna/Atur Pesanan/Validasi/Search name - QA Buyer'), 'QA Buyer')
