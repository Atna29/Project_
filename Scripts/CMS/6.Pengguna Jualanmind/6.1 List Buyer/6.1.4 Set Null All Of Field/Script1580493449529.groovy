...
WebUI.verifyElementText(findTestObject('Object Repository/Admin/Pengguna/Daftar Buyer/Validasi/Tambah Buyer/response field email - Email tidak boleh kosong'), 'Email tidak boleh kosong')

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Pengguna/Daftar Buyer/Validasi/Tambah Buyer/response field password - Kata sandi tidak boleh kosong'), 'Kata sandi tidak boleh kosong')

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Pengguna/Daftar Buyer/Validasi/Tambah Buyer/response field confirm password - Kata sandi tidak boleh kosong'), 'Kata sandi tidak boleh kosong')
