...
WebUI.setText(findTestObject('Admin/Pengguna/Daftar Buyer/Tambah Buyer/Informasi dasar/email field'), 'ceveblboxe.com')

WebUI.verifyElementText(findTestObject('Admin/Pengguna/Daftar Buyer/Validasi/Tambah Buyer/response field email - email tidak valid'), 'Email tidak valid')
