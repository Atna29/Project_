...
WebUI.setText(findTestObject('Admin/Pengguna/Daftar Buyer/Tambah Buyer/Informasi dasar/email field'), GlobalVariable.email_supplier_already_registered)

WebUI.setText(findTestObject('Admin/Pengguna/Daftar Buyer/Tambah Buyer/Informasi dasar/password field'), 'AAss11')

WebUI.setText(findTestObject('Admin/Pengguna/Daftar Buyer/Tambah Buyer/Informasi dasar/confirm password field'), 'AAss11')

WebUI.click(findTestObject('Admin/Pengguna/Daftar Buyer/Tambah Buyer/Informasi dasar/button selanjutnya'))

WebUI.verifyElementText(findTestObject('Object Repository/Admin/Pengguna/Daftar Buyer/Validasi/Tambah Buyer/wording email sudah terdaftar'), 'Email sudah terdaftar!')
