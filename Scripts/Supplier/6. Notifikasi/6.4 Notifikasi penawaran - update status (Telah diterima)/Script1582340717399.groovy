...
WebUI.scrollToElement(findTestObject('Object Repository/Supplier/Notifikasi/Check Terbayar - Sedang Dikirim'), 5)

WebUI.click(findTestObject('Object Repository/Supplier/Notifikasi/Check Terbayar - Sedang Dikirim'))

WebUI.click(findTestObject('Object Repository/Supplier/Notifikasi/Penawaran - button UPDATE STATUS KIRIM'))

WebUI.check(findTestObject('Object Repository/Supplier/Notifikasi/Check Terbayar - Telah diterima'))
