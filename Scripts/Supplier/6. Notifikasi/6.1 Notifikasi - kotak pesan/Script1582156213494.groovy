...
WebUI.click(findTestObject('Object Repository/Supplier/Notifikasi/Notifikasi - Kotak Pesan'))

WebUI.click(findTestObject('Object Repository/Supplier/Notifikasi/Kotak Pesan - Pilih'))