...
WebUI.click(findTestObject('Object Repository/Supplier/Beranda/Menu/Permintaan'))

WebUI.click(findTestObject('Supplier/Permintaan/expand Permintaan'))

WebUI.click(findTestObject('Supplier/Permintaan/Button Proses'))
